    ...
    return (
      <div>
        ...
        <Form className="setting-profile-form" onSubmit={this.handleSubmit}>
          ...
          <Row><Col xs="8">
            <FormGroup className="setting-profile-formgroup">
              <Label className="setting-profile-form-label" style={{ float: "left" }}>Area / Origion: </Label>
              <Input type="text"
                placeholder={this.state.currentUser.areaOrRegion}
                onChange={this.handleAreaOrRegion}
                defaultValue={this.state.currentUser.areaOrRegion} ></Input>
            </FormGroup>
          </Col></Row>

          <Row><Col xs="8">
            <FormGroup className="setting-profile-formgroup">
              <Label className="setting-profile-form-label" style={{ float: "left" }}>Industry: </Label>
              <Input type="text"
                placeholder={this.state.currentUser.industry}
                onChange={this.handleIndustry}
                defaultValue={this.state.currentUser.industry} ></Input>
            </FormGroup>
          </Col></Row>
          ...
          <Row><Col xs="8">
            <FormGroup className="setting-profile-formgroup">
              ...
              <Input type="text"
                ...
                defaultValue={this.state.currentUser.company} ></Input>
            </FormGroup>
          </Col></Row>
          ...
          <Row><Col xs="8">
            <FormGroup className="setting-profile-formgroup">
              ...
              <Input type="textarea" className="setting-profile-description-input"
                placeholder={this.state.currentUser.personalSummary}
                onChange={this.handleDescription}
                defaultValue={this.state.currentUser.personalSummary}></Input>
            </FormGroup>
          </Col></Row>
